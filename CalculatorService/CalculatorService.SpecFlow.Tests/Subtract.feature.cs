...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Subtract", "\tIn order to avoid silly mistakes\r\n\tAs a math idiot\r\n\tI want to be told the diffe" +
        ...
        [NUnit.Framework.TestCaseAttribute("3.2", "2.3", "0.9", null)]
        [NUnit.Framework.TestCaseAttribute("5.5", "6.6", "-1.1", null)]
        public virtual void SubtractTwoNumbers(string value1, string value2, string result, string[] exampleTags)
        {
...
#line 9
 testRunner.When("I subtract the second value from the first value", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 10
